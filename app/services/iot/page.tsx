  ...
  return (
    <main>
      ...
      <section className="relative w-full h-[50vh] flex items-center justify-center text-center">
        <Image
          src="/images/services/iot-hero.jpg"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[300px] rounded-lg overflow-hidden shadow-xl">
              <Image
                src="/images/services/iot-detail.jpg"
                alt="Solutions IoT"
                fill
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-gray-700 text-lg italic mb-4">
                  "Le système d'irrigation connecté conçu par COTECH SERVICES a transformé notre exploitation. 
                  Économie d'eau de 40%, pilotage à distance, alertes SMS. Un vrai gain de temps et d'argent !"
                </p>
                <p className="font-bold text-blue-900">Fatoumata Camara</p>
                <p className="text-gray-500 text-sm">Directrice, AgriTech Guinée</p>
              </div>
            </div>
          </div>
        </div>
