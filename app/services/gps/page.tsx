  ...
  return (
    <main>
      ...
      <section className="relative w-full h-[50vh] flex items-center justify-center text-center">
        <Image
          src="/images/services/gps/gps.jpg"
      ...
      <section id="solutions" className="py-10 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-6 text-center">
            ...
            <div className="p-4">
              ...
              <p className="font-semibold text-gray-900">Colis</p>
              <p className="text-xs text-gray-500">Marchandises et bagages</p>
            </div>
            <div className="p-4">
              <div className="text-4xl mb-2">👌</div>
              <p className="font-semibold text-gray-900">Autres</p>
              <p className="text-xs text-gray-500">Appareils électroniques et objets divers</p>
            </div>
          </div>
        </div>
      </section>
