  ...
  return (
    <main>
      ...
      <section className="relative w-full h-[50vh] flex items-center justify-center text-center">
        <Image
          src="/images/services/infographie-hero.jpg"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[300px] rounded-lg overflow-hidden shadow-xl">
              <Image
                src="/images/services/infographie-detail.jpg"
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-gray-700 text-lg italic mb-4">
                  "COTECH SERVICES a créé toute notre identité visuelle. Le résultat est bluffant : 
                  un logo moderne, une charte graphique cohérente, et des supports de qualité. 
                  Notre image de marque a gagné en professionnalisme."
                </p>
                <p className="font-bold text-blue-900">Mariam Diallo</p>
                <p className="text-gray-500 text-sm">Fondatrice, Création Mode</p>
              </div>
            </div>
          </div>
        </div>
