  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <p className="text-gray-600">Page en construction. Interface pour gérer les formations à venir.</p>
        <div className="mt-8 p-8 text-center border-2 border-dashed rounded-lg">
          <GraduationCap className="h-12 w-12 text-gray-400 mx-auto mb-3" />
          <p className="text-gray-500">Formulaire d'ajout et liste des formations</p>
        </div>
      </div>
    </div>
  );
